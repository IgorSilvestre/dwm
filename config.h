...
static const char *fonts[]          = { "sans-serif:size=10", "monospace:size=10" };
static const char dmenufont[]       = "sans-serif:size=10";
static const char col_gray1[]       = "#0f0f0f"; /* near black */
static const char col_gray2[]       = "#1a1a1a"; /* very dark gray */
static const char col_gray3[]       = "#a0a0a0"; /* light gray */
static const char col_gray4[]       = "#ffffff"; /* white */
static const char col_cyan[]        = "#1a2b4c"; /* dark royal blue */
